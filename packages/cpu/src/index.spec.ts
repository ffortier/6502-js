...
describe('integration tests', () => {
  ...
  describe('fibonacci', () => {
    beforeEach(() => {
      ...
      rom[0x04] = 0xa0;
      rom[0x05] = 0x80;
      rom[0x06] = OpCode.NOP.IMPLIED;//OpCode.TXA.IMPLIED;
      ...
      rom[0xa6] = 0x01;
      rom[0xa7] = OpCode.RTS.IMPLIED;
      rom[0xa8] = OpCode.TXA.IMPLIED;
      rom[0xa9] = OpCode.PHA.IMPLIED;
      rom[0xaa] = OpCode.JSR.ABSOLUTE;
      rom[0xab] = 0xa0;
      rom[0xac] = 0x80;
      rom[0xad] = OpCode.TAY.IMPLIED;
      rom[0xae] = OpCode.PLA.IMPLIED;
      rom[0xaf] = OpCode.TAX.IMPLIED;
      rom[0xb0] = OpCode.TYA.IMPLIED;
      rom[0xb1] = OpCode.PHA.IMPLIED;
      rom[0xb2] = OpCode.DEX.IMPLIED;
      rom[0xb3] = OpCode.JSR.ABSOLUTE;
      rom[0xb4] = 0xa0;
      rom[0xb5] = 0x80;
      rom[0xb6] = OpCode.STA.ABSOLUTE;
      rom[0xb7] = 0xff;
      rom[0xb8] = 0x60;
      rom[0xb9] = OpCode.PLA.IMPLIED;
      rom[0xba] = OpCode.CLC.IMPLIED;
      rom[0xbb] = OpCode.ADC.ABSOLUTE;
      rom[0xbc] = 0x0f;
      rom[0xbd] = 0x60;
      rom[0xbe] = OpCode.RTS.IMPLIED;
    });
